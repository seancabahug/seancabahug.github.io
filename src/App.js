  ...
  return (
    <Routes>
      ...
      <Route path="high-school" element={<HighSchool />}>
        ...
        <Route path="freshman" element={<h1>ayyyy</h1>} />
        <Route path="sophomore" element={<h1>ayyyy</h1>} />
        <Route path="junior" element={<h1>ayyyy</h1>} />
        <Route path="senior" element={<h1>ayyyy</h1>} />
      </Route>
    </Routes>
  );
}
